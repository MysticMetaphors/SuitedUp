...
export default function Navigation() {
    ...
    function toggleNavigation() {
        const menu = document.getElementById('navbar-menus')
        menu.classList.toggle('hidden')
    }

    function toggleLanguage() {
        const drop = document.getElementById('language-dropdown-menu')
        drop.classList.toggle('hidden')
    }

    return (
        <>
            <nav className="bg-transparent-100 border-gray-700">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <div className="flex gap-8 items-center md:order-2 space-x-1 md:space-x-0 rtl:space-x-reverse">
                        <div className="relative">
                            <button onClick={toggleLanguage} type="button" data-dropdown-toggle="language-dropdown-menu" className="inline-flex items-center font-medium justify-center px-4 py-2 text-sm text-primaryGrey-1000 rounded-lg cursor-pointer hover:bg-gray-300 hover:text-black">
                            ...
                            <div className="absolute bottom-[-190px] z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow-sm" id="language-dropdown-menu">
                        ...
                        <button onClick={toggleNavigation} data-collapse-toggle="navbar-menus" type="button" className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-400 rounded-lg md:hidden hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-600" aria-controls="navbar-language" aria-expanded="false">
                    ...
                    <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-menus">
                        <ul className="flex flex-col p-4 md:p-0 mt-4 border border-gray-700 rounded-lg bg-transparent-100 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0">
                            ...
                            <li>
                                <Link className="block py-2 px-3 text-primaryGrey-1000 rounded-lg font-semibold hover:text-black hover:bg-gray-300" to={'/shop'}>Gentlemens</Link>
                            </li>
                            <li>
