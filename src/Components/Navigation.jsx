            ...
            <nav className="bg-transparent-100 border-gray-700">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    <a href="https://flowbite.com/" className="flex items-center space-x-3 rtl:space-x-reverse">
                        ...
                        <span className="self-center text-2xl whitespace-nowrap text-primaryYellow-1000 font-bold hidden md:block">SuitedUp</span>
                    </a>
                    <div className="flex items-center md:order-2 space-x-1 md:space-x-0 rtl:space-x-reverse">
                        ...
                        {/* <button className="h-full px-3 rounded-full bg-gradient-to-r from-primaryYellow-1000 to-primaryDarkYellow-1000 cursor-pointer hidden md:block">
                            Sign Up
                        </button>
                        <button className="ml-2 h-full px-3 rounded-full bg-gradient-to-r from-primaryYellow-1000 to-primaryDarkYellow-1000 cursor-pointer hidden md:block">
                            Sign In
                        </button> */}
