    ...
    return (
        <div className="w-full h-full px-4 sm:px-6 lg:px-12 overflow-hidden">
            <div className="flex flex-col items-center justify-center text-center mt-40">
                ...
                <Link
                    to="/"
                    className="mt-6 px-6 py-3 font-medium bg-gradient-to-r from-primaryYellow-1000 to-primaryDarkYellow-1000 text-white rounded-full shadow-md hover:bg-blue-700 transition"
                >
                    Go Back Home
                </Link>
            </div>
